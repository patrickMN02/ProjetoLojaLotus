...
public class ConsultarVendedor extends javax.swing.JFrame {
    ...
    private void buscarVendedor(Vendedor novoVendedor){
    ...
    if (l < 0){
        ...
        try {
            ...
            while(this.conecta.getResultSet().next()){           
                ...
                String coluna1 = this.conecta.getResultSet().getString("nome").toString().trim();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consultar/Alterar Vendedor");

        jLabel2.setText("Campo:");

        jctipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cód Vendedor", "Nome", "CPF", " " }));
    ...
    private void campoArgumentoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_campoArgumentoKeyReleased
        ...
        if(escolha.equals("Cód Vendedor")){
        tipo = " "+"id";
        }
